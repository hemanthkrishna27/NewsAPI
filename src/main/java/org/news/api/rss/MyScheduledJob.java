...
@Component
public class MyScheduledJob implements CommandLineRunner {
    ...
    public void run(String... args) {
        logger.info("App started. Initial job execution will begin after the initial delay.");
    }
    ...
    public void runScheduledTask() {
        for (String FEED_URL : FEED_URLS) {
            ...
            try {
                ...
                boolean allNew = entries.stream()
                        .map(SyndEntry::getLink)
                        .noneMatch(seenArticles::contains);
